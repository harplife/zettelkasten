...
참고 : 이 [SO 답변](https://math.stackexchange.com/a/229845) 덕분에 조건명제를 잘 정리할 있었다!
...
조건명제를 "If .. Then ..(.. 이면 .. 이다)"로 읽는다. 하지만 이렇게 읽으면 마치 두 명제가 인과관계(Causality)를 가진 것 처럼 느껴진다. 오히려 "whenever (경우에)"가 더 적합한 표현일 듯 싶다.

조건명제를 **함의(Implication)** 라고도 부른다. 
