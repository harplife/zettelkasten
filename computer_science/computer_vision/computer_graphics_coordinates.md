...
뷰 볼륨은 하나의 물체를 두르거나, 또는 하나의 장면을 두를 수 있다. 프로그램이 정의하는 뷰 볼륨에 따라 물체/장면의 일부가 클리핑(Clipping)될 수 있다.
...
3D 모델의 뷰잉을 구현하기 위해 3D 모델을 표현할 여러 공간과, 공간과 공간으로서 전달되며 적용되는 변환들을 알아볼 필요가 있다.
