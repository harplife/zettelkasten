...
유리나 물로 인해 빛이 굴절되는 것은 누구나 볼 수 있는 현상이다. 정확히 누가 프리즘 실험을 처음 시작했는지는 모르지만, 고대 로마 시절에서부터 분산 프리즘은 여러 색이 나오는 멋진 장난감에 불과했다. 그나마 17세기에 이르러 뉴턴의 발견으로 인해 분산 프리즘의 과학적 중요성을 알게되었다.
