...
빛-물체 상호작용에서 빛은 흡수, 반사, 투과한다. 빛이 흡수됨은 빛 에너지가 열로 전환되었음을 뜻하고, 반사와 투과는 빛 에너지가 물체로부터 광자를 방출시켰음을 뜻한다. 반사와 투과는 광자가 방출되는 방향에 따라 구분이 된다.

투과는 빛이 물체를 통해 "이동"하는 것처럼 묘시가 되는데, 빛이 진공간에서 전자기장을 통해 이동하는 것과 달리, 입자에서 입자로 광자가 충돌되며 방출됨을 (빛이 물체를 완전히 통과하거나 또는 완전히 흡수될때까지) 반복된다.
