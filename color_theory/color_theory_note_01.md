...
여기서 "빛을 흡수한다"의 의미는 (일단 여러 자료를 취합해본 결과), 빛이 물체의 입자와 충돌하며 빛의 에너지를 입자로 이동시키며 입자를 들뜨게 (Excite)하고, 들뜬 입자는 진동을 하게된다. 한 마디로, 빛의 에너지를 입자가 모두 흡수하여 진동하게 된다.

입자는 진동하며 안정 상태로 돌아가려고 하며, 진동을 열 에너지로 변환하게 된다.

참고 : 여기서 명시하는 "입자"는 분자 (Molecule) 보다 큰 분자들의 조직이라고 볼 수 있다. 분자는 
