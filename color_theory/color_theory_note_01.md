...
빛에 여러 파장이 있다는 것을 고려하면, 하얀색 빛은 [[#단색광]]을 띤 여러 광선으로 표현할 수 있다. 불투명한 물체를 기준으로, __빛에 비추어진 물체의 색은 물체로 인해 흡수되지 않고 반사된 광선의 색이라 볼 수 있다.__

이론적으로, RGB (빨강,초록,파랑)로 이루어진 하얀 빛이 하얀색 물체, 빨간색 물체, 초록색 물체, 파란색 물체, 그리고 검은색 물체에 비추어진다 하면, 결과는 밑에 그림과 같다.

![[reflection_and_absorption_of_light_on_colored_objects.PNG]]

파란색의 물체는 하얀빛이 비추어질때 파란 빛을 반사하고 나머지 다른 색들은 흡수한다. 그럼으로, 물체는 파란색이라 인식된다. 그러면 빨간 빛이 파란색 물체에 비추어지면 어떻게 될까?
