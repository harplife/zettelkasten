...
반사되는 광선이 의외에 색인 경우가 있다. 파란 빛이 노란색 물체에 비추어지면 초록색으로 보이는 경우가 그렇다. 이러한 경우가 발생되는 이유는,
1. 빛이 단색광이 아니다 - 초록색 주파수는 파란색 주파수와 아주 근접하며, 이 "파란 빛"은 초록색을 약간 품은 파란색 대역의 주파수들을 갖추고 있는 다색광이다.
2. 물체가 여러 주파수를 반사한다 - 
