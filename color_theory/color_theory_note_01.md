...
[염(Salt)](https://en.wikipedia.org/wiki/Salt_(chemistry))은 산(Acid)의 음이온(Negative Ion)과 염기(Base)의 양이온(Positive Ion)이 정전기적 인력으로 결합하고 있는 이온성 화합물(Ionic Compound)을 말한다. 우리가 잘 아는 염은 Sodium Chloride, 즉, 소금이다. 
