...
---
- **Three Schema Architecture** : (1973년 [ANSI](https://en.wikipedia.org/wiki/American_National_Standards_Institute) 에서 제안한) DBMS와 유저 애플리케이션과의 인터페이스를 위한 데이터베이스 구성요소 표준
